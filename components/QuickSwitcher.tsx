...
export function QuickSwitcher() {
  ...
  const toolActions: Result[] = useMemo(() => [
    ...
    { kind: 'doc' as const, key: 'tool:patterns', title: 'Patterns', sub: ctx.isFree ? 'Open the settled fabric' : 'Open the current panel in Patterns', href: ctx.isFree ? '/patterns' : `__action:patterns:${ctx.docId}` },
